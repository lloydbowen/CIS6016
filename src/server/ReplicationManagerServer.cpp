...
{
	//LOG("Debug: %s", "ReplicationManagerServer is writing");
	...
	for( auto& pair: mNetworkIdToReplicationCommand )
	{
		...
		if( replicationCommand.HasDirtyState() )
		{
			...
			//LOG("DEBUG: Writing a dirty object id = %d", networkId);
